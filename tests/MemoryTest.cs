...
namespace BigBangDotNet.Data.Filters.Tests
{
    public class MemoryTests
    {
        ...
        public void IntFilter()
        {
            ...
            condition = BigBangDotNet.Data.Filters.Parsers.Linq.Utils.ToDynamicParameterExpressionOfType(condition, idProperty.Type);
